...
%     LcurvePlot = plot(axLcurve,log(tr_errLc),log(sol_l1_normLc),'r.-');
%     ylabel('\eta = log(||x||_1)')
...
%     hold on
%     plot(axLcurve,log(tr_errLc(indmin)),log(sol_l1_normLc(indmin)),'Color','g','Marker','.','MarkerSize',20)
%     drawnow
%     
%      
%     figError = figure(2);
...
%         LcurvePlot = plot(axLcurveIter,log(tr_errLc),log(sol_l1_normLc),'r.-');
%         ylabel('\eta = log(||x||_1)')
%         xlabel('\xi = log(||Ax - b||_2)')
%         grid on   
% 
%         indmin = find(sol_errLc == min(sol_errLc));
%         hold on
%         plot(axLcurveIter,log(tr_errLc(indmin)),log(sol_l1_normLc(indmin)),'Color','g','Marker','.','MarkerSize',20)
%         drawnow
% 
...
%         plot(axLcurveIter,xi,eta,'Color','k','Marker','o','MarkerSize',5,'LineStyle','none')
%         drawnow
