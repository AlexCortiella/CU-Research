solveBP_pdco_pkg MATLAB Python Package
...
Verify that a Linux version of Python 2.7, 3.6, 3.7, and/or 3.8 is installed.

2. Installing the solveBP_pdco_pkg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
solveBP_pdco_pkg. If you do not have write permissions, copy all its contents to a 
...
3. Using the solveBP_pdco_pkg Package

The solveBP_pdco_pkg package is on your Python path. To import it into a Python script or 
session, execute:
